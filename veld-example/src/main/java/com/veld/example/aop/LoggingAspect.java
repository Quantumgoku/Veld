 ...
 */
package com.veld.example.aop;

import com.veld.annotation.After;
import com.veld.annotation.AfterType;
import com.veld.annotation.Around;
import com.veld.annotation.Aspect;
import com.veld.annotation.Before;
import com.veld.aop.InvocationContext;
import com.veld.aop.JoinPoint;
...
public class LoggingAspect {
     ...
     */
    @Around("execution(* com.veld.example.aop.CalculatorService.*(..))")
     ...
     */
    @Before("execution(* com.veld.example.aop.ProductService.*(..))")
     ...
     */
    @After(value = "execution(* com.veld.example.aop.ProductService.*(..))", 
