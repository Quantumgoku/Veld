...
```gradle
dependencies {
    implementation 'io.github.yasmramos.veld:veld-annotations:1.0.0'
    implementation 'io.github.yasmramos.veld:veld-runtime:1.0.0'
    annotationProcessor 'io.github.yasmramos.veld:veld-maven-plugin:1.0.0'
}
```
...
### Maven Central
- **Search**: https://search.maven.org/artifact/io.github.yasmramos.veld/veld-annotations
...
**Version**: 1.0.0  
**Maven Central**: https://search.maven.org/artifact/io.github.yasmramos.veld/veld-annotations