...
class ContextEventsTest {
    ...
    class EventInheritanceTests {
        ...
        void allContextEventsShouldExtendEvent() {
            assertTrue(new ContextRefreshedEvent(this, 0, 0) instanceof com.veld.runtime.event.Event);
            assertTrue(new ContextStartedEvent(this, 0) instanceof com.veld.runtime.event.Event);
            assertTrue(new ContextStoppedEvent(this, 0) instanceof com.veld.runtime.event.Event);
            assertTrue(new ContextClosedEvent(this, Duration.ZERO, 0) instanceof com.veld.runtime.event.Event);
        }
    }
