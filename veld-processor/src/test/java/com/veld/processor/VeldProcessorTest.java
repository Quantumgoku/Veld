...
class VeldProcessorTest {
    ...
    class SupportedAnnotationsTests {
        ...
        void shouldSupportComponentAnnotation() {
            ...
            assertTrue(supported.contains("com.veld.annotation.Component"), 
        ...
        void shouldSupportSingletonAnnotation() {
            ...
            Set<String> supported = new HashSet<>(Arrays.asList(annotation.value()));
            assertTrue(supported.contains("com.veld.annotation.Singleton"), 
        ...
        void shouldSupportPrototypeAnnotation() {
            ...
            Set<String> supported = new HashSet<>(Arrays.asList(annotation.value()));
            assertTrue(supported.contains("com.veld.annotation.Prototype"), 
        ...
        void shouldSupportLazyAnnotation() {
            ...
            Set<String> supported = new HashSet<>(Arrays.asList(annotation.value()));
            assertTrue(supported.contains("com.veld.annotation.Lazy"), 
                "Should support @Lazy");
        }
    ...
    class ProcessorMethodsTests {
        ...
        void getSupportedAnnotationTypesShouldReturnExpectedAnnotations() {
            ...
            assertTrue(supportedTypes.contains("com.veld.annotation.Component"));
            assertTrue(supportedTypes.contains("com.veld.annotation.Singleton"));
            assertTrue(supportedTypes.contains("com.veld.annotation.Prototype"));
            assertTrue(supportedTypes.contains("com.veld.annotation.Lazy"));
    ...
    class AnnotationCompatibilityTests {
        ...
        void shouldSupportAllVeldNativeAnnotations() {
            ...
            assertTrue(supported.stream().anyMatch(s -> s.startsWith("com.veld.annotation.")),
    ...
    class AnnotationTypeCoverageTests {
        ...
        void shouldCoverSingletonScopeViaMultipleAnnotations() {
            ...
            assertTrue(supported.contains("com.veld.annotation.Singleton"));
            assertTrue(supported.contains("com.veld.annotation.Lazy")); // Lazy implies Singleton
            assertTrue(supported.contains("javax.inject.Singleton"));
            assertTrue(supported.contains("jakarta.inject.Singleton"));
        }
